...
CheckoutActions.navigateToCart()

CheckoutActions.clickCheckoutButton()
CheckoutActions.FillCheckoutInformation()

CheckoutActions.clickContinueButton()

CheckoutActions.clickFinishButton()

CheckoutVerification.verifyCompleteOrder()

CheckoutActions.clickBackHomeButton()

CheckoutVerification.verifyProductPage()
WebUI.closeBrowser()